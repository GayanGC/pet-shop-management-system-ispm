        ...
        <div className="lg:col-span-1 space-y-4 border-r border-slate-100 dark:border-slate-800 pr-0 lg:pr-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs focus:bg-white dark:focus:bg-slate-900 focus:border-teal-500 focus:outline-none transition-all text-slate-800 dark:text-slate-100"
            >
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">Custom Service / Item Name</label>
            <input
              type="text"
                ...
                {cartItems.length > 0 ? (
                  cartItems.map((item, idx) => (
                    <tr key={idx} className="bg-white dark:bg-slate-900 hover:bg-slate-50/60 dark:hover:bg-slate-800/50 transition-colors">
                      <td className="py-2.5 px-3.5 font-semibold text-slate-800 dark:text-slate-100">{item.itemName}</td>
